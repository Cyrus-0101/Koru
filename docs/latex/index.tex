...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md4}{}\doxysection{\texorpdfstring{🧠 Overview}{🧠 Overview}}\label{index_autotoc_md4}
...
All code is written in {\bfseries{C99}}, making it ideal for performance-\/critical applications while keeping dependencies minimal.\hypertarget{index_autotoc_md5}{}\doxysection{\texorpdfstring{🖼 Architecture}{🖼 Architecture}}\label{index_autotoc_md5}
The high-\/level architecture of Koru is divided into four main layers\+:\hypertarget{index_autotoc_md6}{}\doxysubsection{\texorpdfstring{1. $<$strong$>$\+Platform Layer$<$/strong$>$}{1. <strong>Platform Layer</strong>}}\label{index_autotoc_md6}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md7}{}\doxysubsection{\texorpdfstring{2. $<$strong$>$\+Core$<$/strong$>$}{2. <strong>Core</strong>}}\label{index_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md8}{}\doxysubsection{\texorpdfstring{3. $<$strong$>$\+Resource Management$<$/strong$>$}{3. <strong>Resource Management</strong>}}\label{index_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md9}{}\doxysubsection{\texorpdfstring{4. $<$strong$>$\+Application Layer$<$/strong$>$}{4. <strong>Application Layer</strong>}}\label{index_autotoc_md9}
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md11}{}\doxysection{\texorpdfstring{📋 Feature List}{📋 Feature List}}\label{index_autotoc_md11}
Here’s a summary of the features to be implemented in v0.\+1\+:\hypertarget{index_autotoc_md12}{}\doxysubsection{\texorpdfstring{Core Features}{Core Features}}\label{index_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md13}{}\doxysubsection{\texorpdfstring{Planned Features}{Planned Features}}\label{index_autotoc_md13}
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md15}{}\doxysection{\texorpdfstring{🖼 Visual Assets}{🖼 Visual Assets}}\label{index_autotoc_md15}
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md17}{}\doxysection{\texorpdfstring{📁 Project Structure}{📁 Project Structure}}\label{index_autotoc_md17}

\begin{DoxyCode}{0}
\DoxyCodeLine{.}
\DoxyCodeLine{├──\ assets/\ \ \ \ \ \ \ \ \ \ \ \ \ \ \#\ Diagrams\ showing\ architecture\ and\ feature\ list}
\DoxyCodeLine{├──\ bin/\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \#\ Compiled\ binaries\ (engine\ shared\ lib\ +\ testbed\ app)}
\DoxyCodeLine{├──\ build-\/all.bat\ \ \ \ \ \ \ \ \#\ Build\ script\ for\ Windows\ (builds\ all\ modules)}
\DoxyCodeLine{├──\ build-\/all.sh\ \ \ \ \ \ \ \ \ \#\ Build\ script\ for\ Linux\ (builds\ all\ modules)}
\DoxyCodeLine{├──\ engine/\ \ \ \ \ \ \ \ \ \ \ \ \ \ \#\ Core\ engine\ code\ and\ platform\ abstraction}
\DoxyCodeLine{│\ \ \ ├──\ build.bat\ \ \ \ \ \ \ \ \#\ Windows\ build\ script\ for\ engine\ (.dll)}
\DoxyCodeLine{│\ \ \ ├──\ build.sh\ \ \ \ \ \ \ \ \ \#\ Linux\ build\ script\ for\ engine\ (.so)}
\DoxyCodeLine{│\ \ \ └──\ src/}
\DoxyCodeLine{│\ \ \ \ \ \ \ ├──\ core/\ \ \ \ \ \ \ \ \#\ Core\ utilities:\ logging,\ asserts,\ memory}
\DoxyCodeLine{│\ \ \ \ \ \ \ ├──\ defines.h\ \ \ \ \#\ Common\ definitions\ and\ macros}
\DoxyCodeLine{│\ \ \ \ \ \ \ └──\ platform/\ \ \ \ \#\ Platform-\/specific\ code\ (Linux/Windows)}
\DoxyCodeLine{├──\ LICENSE\ \ \ \ \ \ \ \ \ \ \ \ \ \ \#\ MIT\ License}
\DoxyCodeLine{├──\ README.md\ \ \ \ \ \ \ \ \ \ \ \ \#\ This\ file}
\DoxyCodeLine{└──\ testbed/\ \ \ \ \ \ \ \ \ \ \ \ \ \#\ Example\ application\ that\ uses\ the\ engine}
\DoxyCodeLine{\ \ \ \ ├──\ build.bat\ \ \ \ \ \ \ \ \#\ Windows\ build\ script\ for\ testbed}
\DoxyCodeLine{\ \ \ \ ├──\ build.sh\ \ \ \ \ \ \ \ \ \#\ Linux\ build\ script\ for\ testbed}
\DoxyCodeLine{\ \ \ \ └──\ src/}
\DoxyCodeLine{\ \ \ \ \ \ \ \ └──\ main.c\ \ \ \ \ \ \ \#\ Entry\ point\ for\ testbed\ application}

\end{DoxyCode}


\DoxyHorRuler{0}
\hypertarget{index_autotoc_md19}{}\doxysection{\texorpdfstring{⚙️ Build Scripts/\+Instructions}{⚙️ Build Scripts/Instructions}}\label{index_autotoc_md19}
...
\end{longtabu}
\hypertarget{index_autotoc_md20}{}\doxysubsection{\texorpdfstring{Linux}{Linux}}\label{index_autotoc_md20}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md21}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{index_autotoc_md21}
Ensure\+:
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md23}{}\doxysection{\texorpdfstring{🔮 Roadmap}{🔮 Roadmap}}\label{index_autotoc_md23}
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md25}{}\doxysection{\texorpdfstring{💡 Want to Help?}{💡 Want to Help?}}\label{index_autotoc_md25}
