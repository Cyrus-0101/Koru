...
\renewcommand{\familydefault}{\sfdefault}
  ...
  \fancypagestyle{fancyplain}{
    ...
    \fancyfoot[LO, RE]{\bfseries\scriptsize Generated on Tue Oct 7 2025 11\+:37\+:28 for Koru Game Engine by Doxygen }
  }
...
\input{structgeometry__config}
\input{structgeometry__reference}
\input{structgeometry__system__config}
\input{structgeometry__system__state}
...
\input{structmaterial__config}
\input{structmaterial__reference}
\input{structmaterial__system__config}
\input{structmaterial__system__state}
...
\input{structtexture}
\input{structtexture__map}
\input{structtexture__reference}
\input{structtexture__system__config}
\input{structtexture__system__state}
\input{unionvec2__u}
\input{structvec3__u}
\input{unionvec4__u}
...
\input{vulkan__material__shader_8c}
\input{vulkan__material__shader_8c_source}
\input{vulkan__material__shader_8h}
\input{vulkan__material__shader_8h_source}
...
\input{resource__types_8h}
\input{resource__types_8h_source}
\input{geometry__system_8c}
\input{geometry__system_8c_source}
\input{geometry__system_8h}
\input{geometry__system_8h_source}
\input{material__system_8c}
\input{material__system_8c_source}
\input{material__system_8h}
\input{material__system_8h_source}
\input{texture__system_8c}
\input{texture__system_8c_source}
\input{texture__system_8h}
\input{texture__system_8h_source}
\input{stb__image_8h}
