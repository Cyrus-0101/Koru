...
typedef unsigned short u16;      // 16-bit unsigned integer (2 bytes)
typedef unsigned int u32;        // 32-bit unsigned integer (4 bytes)
typedef unsigned long long u64;  // 64-bit unsigned integer (8 bytes)

// Signed integer types with guaranteed sizes
typedef signed char i8;        // 8-bit signed integer (1 byte)
typedef signed short i16;      // 16-bit signed integer (2 bytes)
typedef signed int i32;        // 32-bit signed integer (4 bytes)
typedef signed long long i64;  // 64-bit signed integer (8 bytes)

// Floating-point types
typedef float f32;   // 32-bit floating point (4 bytes)
typedef double f64;  // 64-bit floating point (8 bytes)

// Boolean types
typedef int b32;  // 32-bit boolean (can be TRUE/FALSE)
typedef char b8;  // 8-bit boolean (more memory-efficient than b32)
