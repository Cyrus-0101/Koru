...
/**
 * @brief Creates the default geometry used as a fallback.
 *
 * @param state Pointer to the geometry system state.
 * @return True if the default geometry was created successfully, False otherwise.
 */
b8 create_default_geometry(geometry_system_state* state);

/**
 * @brief Creates a new geometry based on the provided configuration and registers it in the system.
 *
 * @param state Pointer to the geometry system state.
 * @param config Configuration parameters for the geometry to be created.
 * @param g Pointer to the geometry structure to be populated.
 * @return True if the geometry was created successfully, False otherwise.
 */
b8 create_geometry(geometry_system_state* state, geometry_config config, geometry* g);

/**
 * @brief Destroys the specified geometry and releases its resources.
 *
 * @param state Pointer to the geometry system state.
 * @param g Pointer to the geometry to be destroyed.
 */
