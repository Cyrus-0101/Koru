 ...
 *
 * @brief Implementation of the resource system.
 *
 * This module implements the functions defined in `resource_system.h`.
 * It manages the loading, unloading, and registration of resources.
 */

/**
 * @struct resource_system_state
 *
 * @brief Internal state of the resource system.
 */
typedef struct resource_system_state {
    /** Configuration settings for the resource system. */
    resource_system_config config;
    /** Array of registered loaders. */
    resource_loader* registered_loaders;
} resource_system_state;

/**
 * @brief Pointer to the global resource system state.
 */
static resource_system_state* state_ptr = 0;

/**
 * @brief Loads a resource from a loader and initializes the resource structure.
 *
 * @param name The name of the resource to load.
 * @param loader Pointer to the loader to use for loading the resource.
